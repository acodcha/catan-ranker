...
public:
  ...
  Player(const PlayerName& name, const std::string& color, const uint8_t gnuplot_point_type) noexcept : name_(name), color_(color), gnuplot_point_type_(gnuplot_point_type) {}
  ...
  const uint8_t gnuplot_point_type() const noexcept {
