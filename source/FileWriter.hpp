...
public:
  ...
  constexpr const std::experimental::filesystem::perms&
...
protected:
  constexpr FileWriter(
      ...
      const std::experimental::filesystem::perms& permissions =
          {std::experimental::filesystem::perms::owner_read
           ...
           | std::experimental::filesystem::perms::others_read}) noexcept
