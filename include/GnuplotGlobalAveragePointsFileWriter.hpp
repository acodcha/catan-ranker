...
class GnuplotGlobalAveragePointsFileWriter : public GnuplotFileWriter {

public:

  GnuplotGlobalAveragePointsFileWriter(const std::experimental::filesystem::path& path) noexcept : GnuplotFileWriter(path) {
...
class GnuplotGlobalAveragePointsVsGameNumberFileWriter : public GnuplotGlobalAveragePointsFileWriter {
...
public:
  ...
  ) noexcept : GnuplotGlobalAveragePointsFileWriter(path) {
...
class GnuplotGlobalAveragePointsVsDateFileWriter : public GnuplotGlobalAveragePointsFileWriter {
