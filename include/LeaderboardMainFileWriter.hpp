...
protected:
  ...
  void players_table(const Players& players, const GameCategory game_category) noexcept {
    ...
    const Table data{{name, number_of_games, average_points_per_game, first_place, second_place, third_place, first_or_second_place, first_or_second_or_third_place}};
    table(data);
  }
